...
public class ComprobanteRetencionIr  implements java.io.Serializable {
    ...
    public ComprobanteRetencionIr(long idComprobanteRetencion, ComprobanteRetencion comprobanteRetencion, int anio, int mes, double baseImponible, double porcentajeRetencion, double valorRetenido) {
